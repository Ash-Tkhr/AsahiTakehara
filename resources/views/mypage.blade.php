                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center text-dark">
                        <p><a class="btn btn-outline-dark my-2 my-sm-0" href="{{ route('article.edit',['article'=>$article['id']])}}" role="button">
                            ...
                            <input class="btn btn-outline-dark my-2 my-sm-0" value='削除' type="submit" 
                            data-toggle="modal" data-target="#testModal" onclick='return confirm("削除しますか？");'>
                                @method('delete')  
                                @csrf       
                            </form>               
                        </div>
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header"><h4>投稿削除</h4></div>
                                    <div class="modal-body"><p>この投稿を削除しますか？</p></div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="400" height="500" viewBox="0 0 400 500" preserveAspectRatio="none" style="display: none; visibility: hidden; position: absolute; top: -100%; left: -100%;"><defs><style type="text/css"></style></defs><text x="0" y="13" style="font-weight:bold;font-size:13pt;font-family:Arial, Helvetica, Open Sans, sans-serif">Thumbnail</text></svg>
